...
<html lang="en">
	...
	<meta name="description" content="3η Ατομική Άσκηση - Index">
	<meta name="author" content="sofos@aueb.gr">


	<title>3η Ατομική Άσκηση - Index page</title>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index_ex3_8150105.jsp">Home</a></li>					
						<li><a href="about_ex3_8150105.jsp">About</a></li>					
					</ul>	
					
					<ul class="nav navbar-nav navbar-right">
                        <li>
							<li><a href="register_ex3_8150105.jsp">Register</a></li>
							<li><a href="login_ex3_8150105.jsp">Sign in</a></li>	
						</li>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li  class="active"><a href="index_ex3_8150105.jsp">Home</a></li>					
						<li><a href="about_ex3_8150105.jsp">About</a></li>	
						<li><a href="<%=request.getContextPath() %>/dashboard_ex3_8150105.jsp">Dashboard</a></li>				
					</ul>	
