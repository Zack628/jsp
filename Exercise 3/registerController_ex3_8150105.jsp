...
<html lang="en">
	...
	<meta name="description" content="3η Ατομική Άσκηση - RegisterController page">
	...
	<body>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="register_ex3_8150105.jsp">Register</a></li>					
		...
		<div class="container theme-showcase" role="main">
            ...
            <% if (CountErrors > 0 || request.getAttribute("message") != null) {
            %>
        ...
        <div class ="row">
            ...
            %>
             ...
             <a class="btn btn-primary" href="register_ex3_8150105.jsp" role="button"> <span class="glyphicon glyphicon-chevron-left"></span> <b> Back to the form </b></a>
